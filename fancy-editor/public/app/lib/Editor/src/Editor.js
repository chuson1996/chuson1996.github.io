    ...
    function editorMenuEvents(){
        ...
        EventListener.addEventListener().on(elements.editor).with({
            'paste': (e) => {
                ...
                let clipboardData = document.createElement('div');
                ...
                hp.node(clipboardData).removeAttributes();
                hp.node(clipboardData).editorFormat();
                ...
                if (hp.isAtEndOfLine(block, curRange)){
                    ...
                    if (clipboardData.childNodes.length) {
                        let lastChild = clipboardData.lastElementChild;
                    ...
                    if (clipboardData.children.length){
                        _.forEach(clipboardData.children, function(clipboardChild){
                            ...
                            hp.moveCursorTo({startContainer: clipboardChild, collapse: false});
                        });
                    }
                }
            },
